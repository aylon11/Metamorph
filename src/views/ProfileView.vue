  ...
  <div class="min-h-screen bg-stone-50 text-slate-900 font-sans flex flex-col selection:bg-emerald-500/20">
    ...
    <nav class="bg-white border-b border-stone-200 z-50 sticky top-0">
      <div class="w-full px-8 h-16 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          ...
          >
            <ArrowLeft class="w-4 h-4" /> Logout
          </button>
    ...
    <main class="flex-1 overflow-y-auto custom-scrollbar bg-stone-50/50">
      <div class="max-w-7xl mx-auto py-12 px-8">
        ...
        <!-- Profile Header -->
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6 bg-white p-8 rounded-[32px] border border-stone-200 shadow-xl premium-shadow">
          <div class="flex items-center gap-6">
            <div class="w-20 h-20 rounded-2xl border-2 border-emerald-500 overflow-hidden shadow-lg">
              <img src="../assets/user_avatar.png" alt="User Profile" class="w-full h-full object-cover" />
            </div>
            <div>
              <h1 class="text-3xl font-black text-slate-950 tracking-tight mb-1">Libby McLiblib</h1>
              <p class="text-slate-500 font-medium flex items-center gap-2">
                <Globe class="w-4 h-4 text-slate-400" /> libby@example.com
              </p>
              <div class="flex gap-2 mt-2">
                <span class="px-2 py-0.5 bg-blue-50 text-blue-600 text-[10px] font-black uppercase tracking-widest rounded-full border border-blue-100">Pro Plan</span>
                <span class="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-[10px] font-black uppercase tracking-widest rounded-full border border-emerald-100">Active</span>
              </div>
            </div>
          </div>
          
          <div class="flex gap-4">
            <button class="px-4 py-2.5 bg-stone-100 hover:bg-stone-200 text-slate-700 rounded-xl text-sm font-bold transition-colors flex items-center gap-2">
              <Settings class="w-4 h-4" /> Settings
            </button>
            <button class="px-4 py-2.5 bg-slate-950 hover:bg-slate-800 text-white rounded-xl text-sm font-bold transition-colors flex items-center gap-2">
              <Zap class="w-4 h-4 text-emerald-400" /> Upgrade
            </button>
          </div>
        </div>
        ...
        <div class="mb-10">
          <h2 class="text-xl font-black text-slate-950 tracking-tight mb-6">Connected Accounts</h2>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Google Ads Account -->
            <div class="bg-white p-6 rounded-[24px] border border-stone-200 shadow-xl premium-shadow flex items-center justify-between">
              <div class="flex items-center gap-4">
                <div class="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-md border border-stone-100 p-2.5">
                ...
                <div>
                  <div class="text-sm font-bold text-slate-900">Google Ads</div>
                  <div class="text-xs text-slate-500">ID: 482-910-3342</div>
                </div>
              </div>
              <span class="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-[10px] font-black uppercase tracking-widest rounded-full border border-emerald-100">Connected</span>
            </div>

            <!-- Meta Ads Account -->
            <div class="bg-white p-6 rounded-[24px] border border-stone-200 shadow-xl premium-shadow flex items-center justify-between">
              <div class="flex items-center gap-4">
                <div class="w-12 h-12 bg-[#0668E1] rounded-xl flex items-center justify-center shadow-md text-white p-2.5">
                ...
                <div>
                  <div class="text-sm font-bold text-slate-900">Meta Ads</div>
                  <div class="text-xs text-slate-500">act_89221044</div>
                </div>
              </div>
              <span class="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-[10px] font-black uppercase tracking-widest rounded-full border border-emerald-100">Connected</span>
            </div>
        ...
        <div class="mb-10">
          <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-black text-slate-950 tracking-tight">Performance Dashboard</h2>
            <div class="bg-white px-4 py-2 rounded-xl shadow-sm border border-stone-200 flex items-center gap-3">
              <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest">ROI Lift</span>
              <span class="text-base font-black text-emerald-600 flex items-center gap-1">
                <TrendingUp class="w-4 h-4" /> {{ data.summary.roiLift }}
              </span>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
            <div class="bg-white rounded-[24px] p-6 border border-stone-200 shadow-xl premium-shadow hover:translate-y-[-4px] transition-all">
              ...
              <div class="text-xs font-medium text-slate-500">Across Platforms</div>
            </div>
          ...
          <!-- Chart -->
          <div class="bg-white rounded-[32px] border border-stone-200 overflow-hidden shadow-xl premium-shadow mb-10">
               ...
               <div class="relative h-[240px] w-full mb-6 bg-stone-50/30 rounded-2xl p-6">
                  ...
                  <div class="ml-12 h-full relative">
                      <svg class="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 600 200">
                          ...
                          <path :d="curvePointsGoogle" fill="none" stroke="#3B82F6" stroke-width="4" stroke-linecap="round" class="drop-shadow-lg" />
                          <path :d="curvePointsMeta" fill="none" stroke="#94A3B8" stroke-width="3" stroke-linecap="round" stroke-dasharray="5 5" class="opacity-80" />
                          <path :d="curvePointsOverallRoi" fill="none" stroke="#10B981" stroke-width="5" stroke-linecap="round" class="drop-shadow-lg" />
                      </svg>
                  </div>
               </div>
        ...
        <!-- Deployed Campaigns Section -->
        <div>
          <h2 class="text-xl font-black text-slate-950 tracking-tight mb-6">Deployed Campaigns</h2>
          
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <!-- Google Ads Block -->
            <div class="bg-white rounded-[32px] border border-stone-200 overflow-hidden shadow-xl premium-shadow">
              <div class="p-8 border-b border-stone-100 bg-gradient-to-tr from-blue-50/50 to-transparent flex items-center justify-between">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <div class="text-sm font-black text-slate-950">Google Ads</div>
                    <div class="text-xs text-slate-400 font-bold uppercase tracking-widest">Primary Growth Engine</div>
                  </div>
                </div>
              ...
              <div class="p-8 space-y-4">
                <div v-for="camp in data.googleAds.campaigns" :key="camp.id" class="p-4 bg-stone-50 rounded-2xl border border-stone-100 hover:border-emerald-500/30 transition-colors flex justify-between items-center">
                  <div>
            ...
            <div class="bg-white rounded-[32px] border border-stone-200 overflow-hidden shadow-xl premium-shadow">
              <div class="p-8 border-b border-stone-100 bg-gradient-to-tr from-blue-50/50 to-transparent flex items-center justify-between">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <div class="text-sm font-black text-slate-950">Meta Ads</div>
                    <div class="text-xs text-slate-400 font-bold uppercase tracking-widest">Top Funnel Feeder</div>
                  </div>
                </div>
                <span class="px-3 py-1 bg-blue-50 text-blue-600 text-xs font-bold rounded-full border border-blue-100 flex items-center gap-1">
                  <Shield class="w-3 h-3" /> Verified
              ...
              <div class="p-8 space-y-4">
                <div v-for="camp in data.metaAds.campaigns" :key="camp.id" class="p-4 bg-stone-50 rounded-2xl border border-stone-100 hover:border-emerald-500/30 transition-colors flex justify-between items-center">
                  <div>
                    <div class="text-sm font-bold text-slate-800 flex items-center gap-2">
                      {{ camp.name }}
                      <span class="px-1.5 py-0.5 bg-stone-100 text-stone-500 text-[9px] font-bold uppercase tracking-widest rounded">{{ camp.status }}</span>
