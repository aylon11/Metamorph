    ...
    <main class="flex-1 max-w-4xl mx-auto w-full p-8 py-20 pb-40">
      <div class="mb-16 text-center space-y-6 animate-fade-in-up">
        <div class="inline-flex p-4 bg-white rounded-3xl shadow-xl border border-stone-100 premium-shadow mb-4">
          <Settings class="w-8 h-8 text-emerald-500" />
        </div>
      ...
      <div class="space-y-8 animate-fade-in-up" style="animation-delay: 0.1s">
        ...
        <div class="bg-white border border-stone-200 rounded-[32px] p-8 shadow-2xl premium-shadow relative overflow-hidden group">
          ...
          <div class="grid sm:grid-cols-2 gap-4">
            <label class="cursor-pointer group relative">
              ...
              <div class="p-8 rounded-2xl border-4 transition-all duration-300 flex flex-col items-center gap-4 text-center overflow-hidden h-full"
                   :class="config.geo === 'ai' ? 'border-emerald-500 bg-white shadow-2xl scale-[1.02]' : 'border-transparent bg-stone-50/50 hover:border-emerald-500/30'">
            ...
            <label class="cursor-pointer group relative">
              ...
              <div class="p-8 rounded-2xl border-4 transition-all duration-300 flex flex-col items-center gap-4 text-center overflow-hidden h-full"
                   :class="config.geo === 'manual' ? 'border-emerald-500 bg-white shadow-2xl scale-[1.02]' : 'border-transparent bg-stone-50/50 hover:border-emerald-500/30'">
          ...
          <div v-if="config.geo === 'manual'" class="mt-8 transition-all animate-fade-in-up">
            <input type="text" placeholder="e.g., United States, London, Tokyo" class="w-full bg-stone-50 border border-stone-200 rounded-2xl px-6 py-5 text-sm font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500/30 transition-all shadow-sm" />
          </div>
        </div>
        ...
        <div class="bg-white border border-stone-200 rounded-[32px] p-8 shadow-2xl premium-shadow relative overflow-hidden group">
          ...
          <div class="grid sm:grid-cols-2 gap-4">
             <label class="cursor-pointer group relative">
              ...
              <div class="p-8 rounded-2xl border-4 transition-all duration-300 flex flex-col items-center gap-4 text-center overflow-hidden h-full"
                   :class="config.audience === 'ai' ? 'border-emerald-500 bg-white shadow-2xl scale-[1.02]' : 'border-transparent bg-stone-50/50 hover:border-emerald-500/30'">
                <div class="absolute top-4 right-4 transition-opacity duration-300"
             ...
             <label class="cursor-pointer group relative">
              ...
              <div class="p-8 rounded-2xl border-4 transition-all duration-300 flex flex-col items-center gap-4 text-center overflow-hidden h-full"
                   :class="config.audience === 'manual' ? 'border-emerald-500 bg-white shadow-2xl scale-[1.02]' : 'border-transparent bg-stone-50/50 hover:border-emerald-500/30'">
                <div class="absolute top-4 right-4 transition-opacity duration-300"
          ...
          <div v-if="config.audience === 'manual'" class="mt-8 transition-all animate-fade-in-up">
            <input type="text" placeholder="e.g., Luxury buyers, Tech enthusiasts" class="w-full bg-stone-50 border border-stone-200 rounded-2xl px-6 py-5 text-sm font-bold text-slate-900 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500/30 transition-all shadow-sm" />
          </div>
        </div>
          ...
          <div class="grid sm:grid-cols-3 gap-4">
             <label class="cursor-pointer group relative">
              ...
              <div class="p-6 rounded-2xl border-4 transition-all duration-300 flex flex-col items-center text-center relative overflow-hidden h-full"
                   :class="config.intent === 'ai' ? 'border-emerald-500 bg-white shadow-xl scale-[1.02]' : 'border-transparent bg-stone-50/50 hover:border-emerald-500/30'">
                ...
                <Sparkles class="w-6 h-6 mb-2 transition-colors duration-300" 
                          :class="config.intent === 'ai' ? 'text-emerald-500' : 'text-slate-400'" />
            ...
            <label class="cursor-pointer group relative">
              ...
              <div class="p-6 rounded-2xl border-4 transition-all duration-300 flex flex-col items-center text-center relative overflow-hidden h-full"
                   :class="config.intent === 'broad' ? 'border-emerald-500 bg-white shadow-xl scale-[1.02]' : 'border-transparent bg-stone-50/50 hover:border-emerald-500/30'">
                <div class="absolute top-2 right-2 transition-opacity duration-300"
                     :class="config.intent === 'broad' ? 'opacity-100' : 'opacity-0'">
                    <Check class="w-4 h-4 text-emerald-500" />
                </div>
                <Target class="w-6 h-6 mb-2 transition-colors duration-300" 
                        :class="config.intent === 'broad' ? 'text-emerald-500' : 'text-slate-400'" />
                <span class="font-black text-[10px] uppercase tracking-[0.1em] transition-colors duration-300"
            ...
            <label class="cursor-pointer group relative">
              ...
              <div class="p-6 rounded-2xl border-4 transition-all duration-300 flex flex-col items-center text-center relative overflow-hidden h-full"
                   :class="config.intent === 'exact' ? 'border-emerald-500 bg-white shadow-xl scale-[1.02]' : 'border-transparent bg-stone-50/50 hover:border-emerald-500/30'">
                <div class="absolute top-2 right-2 transition-opacity duration-300"
                     :class="config.intent === 'exact' ? 'opacity-100' : 'opacity-0'">
                    <Check class="w-4 h-4 text-emerald-500" />
                </div>
                <Rocket class="w-6 h-6 mb-2 transition-colors duration-300" 
                        :class="config.intent === 'exact' ? 'text-emerald-500' : 'text-slate-400'" />
                <span class="font-black text-[10px] uppercase tracking-[0.1em] transition-colors duration-300"
      ...
      <div class="mt-20 flex justify-center pb-20 animate-fade-in-up" style="animation-delay: 0.2s">
        ...
        >
          ...
          <Rocket class="w-6 h-6 text-emerald-500" />
